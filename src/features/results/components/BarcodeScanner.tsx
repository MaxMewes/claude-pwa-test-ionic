...
export const BarcodeScanner: React.FC<BarcodeScannerProps> = ({
  ...
  useEffect(() => {
      ...
      try {
        ...
        scannerCleanup = async () => {
          try {
            ...
            logger.error('Error cleaning up scanner:', err);
          }
        };
        ...
        await scanner.start(
          ...
          (decodedText, decodedResult) => {
            ...
            logger.info('Barcode detected:', decodedText, 'Format:', decodedResult.result.format);
    ...
    return () => {
      ...
      if (scannerCleanup) {
        scannerCleanup().catch(err => logger.error('Cleanup error:', err));
      } else {
        stopScanner().catch(err => logger.error('Cleanup error:', err));
      }
